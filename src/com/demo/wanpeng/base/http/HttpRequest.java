...
import com.demo.wanpeng.base.CacheManager;

public class HttpRequest implements Runnable {
	private final static String cookiePath = "/data/data/com.demo.wanpeng/cookie";
	// 区分get还是post的枚举
...
//			        } } 			        
			        ...
			        final String strResponse = sb.toString();
									
					// 把成功获取到的数据记录到缓存
					if (urlData.getNetType().equals(REQUEST_GET) && urlData.getExpires() > 0) {
						CacheManager.getInstance().putFileCache(newUrl,strResponse,urlData.getExpires());
					}
